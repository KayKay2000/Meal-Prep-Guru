...
export default function Italian() {
  ...
  useEffect(() => {
    dispatch(setSearch('cuisine', "italian"))
  }, [dispatch])
        ...
        <div className='background'>
          ...
          >
            ...
            <GridItem colSpan={2} bg='rgb(38, 45, 51)'>
              <br />
              <Heading as='h2' size='xl' className='logo' pt='10' color='white' alignContent='center' paddingBottom={10} paddingLeft={4}>Italian Recipes</Heading>
