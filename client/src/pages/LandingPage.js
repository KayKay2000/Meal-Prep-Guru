...
function LandingPage() {
    ...
    return (
        <div className='parent'>
            ...
            <Heading as='h2' size='3xl' isTruncated className='logo'>Meal Prep Guru</Heading>
            <br /><br />
                ...
                <FormControl isRequired>
                    ...
                    <Input id='first-name' placeholder='First name' borderRadius={70} />
                    <FormLabel htmlFor='last-name'>Last name</FormLabel>
                    <Input id='last-name' placeholder='Last name' borderRadius={70} />
                    <FormLabel htmlFor='email'>Email</FormLabel>
                    <Input id='email' placeholder='Email' type="email" borderRadius={70} />
