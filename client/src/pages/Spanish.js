...
export default function Spanish() {
  ...
  useEffect(() => {
    dispatch(setSearch('cuisine', "spanish"))
  }, [dispatch])
        ...
        <div className='background'>
          ...
          >
            ...
            <GridItem colSpan={2} bg='rgb(38, 45, 51)'>
              <br />
              <Heading as='h2' size='xl' className='logo' pt='10' color='white' alignContent='center' paddingBottom={10} paddingLeft={4}>Spanish Recipes</Heading>
