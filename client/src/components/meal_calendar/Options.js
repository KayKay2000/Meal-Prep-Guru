...
function Options(props) {
    ...
    const handleRemoveItem = () => {
        axios.delete(`https://api.spoonacular.com/mealplanner/${user.currentUser.spoonacularUsername}/items/${props.item.id}?hash=${user.currentUser.spoonacularHash}&apiKey=${process.env.REACT_APP_API_KEY}`)
        .then(() => {
            props.render();
        })
    }
